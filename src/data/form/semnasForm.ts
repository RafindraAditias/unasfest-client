...
interface SEMNASFormFields extends formFields {
  formName: FieldPath<Zod.infer<typeof SEMNASSchema>>;
  subInput?: {
    title?: string;
    formName: FieldPath<Zod.infer<typeof SEMNASSchema>>;
    description?: string;
...
interface SEMNASFormType extends FormType {
  formFields: Array<SEMNASFormFields>;
}

const SEMNASForm: SEMNASFormType = {
